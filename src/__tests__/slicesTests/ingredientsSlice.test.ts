...
describe('Ingredients slice tests', () => {
  it('Test should set isIngredientsLoading to true and err to null during pending status', () => {
  ...
  it('Test should set isIngredientsLoading to false and upd ingredients', () => {
    const actualState = ingredientsSlice.reducer(
      {
        ...initialState,
        isIngredientsLoading: true //Устанавливаем `isIngredientsLoading` в `true`, имитируя активную загрузку данных
      },
  ...
  it('Test should set isIngredientsLoading to false and err to err message', () => {
    ...
    //Проверка ОР:
    // - `isIngredientsLoading` будет установлено в `false`, так как загрузка завершилась с ошибкой.
